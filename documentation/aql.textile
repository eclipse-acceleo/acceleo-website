...
You can also register your EPacakges. Only registered EPacakges are used to validate and evaluate AQL expression.
...
By default the EClass is mapped to Map.Entry which is not an EObject. This prevent using services on EObject.
